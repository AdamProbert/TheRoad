...
{
    [CustomEditor(typeof(EdgeDetection_Coloured))]
    class EdgeDetection_ColouredEditor : Editor
    {
        ...
        SerializedProperty edgeDetectShader;
        ...
        void OnEnable () {
            ...
            edgeDetectShader = serObj.FindProperty("edgeDetectShader");

            edgeExp = serObj.FindProperty("edgeExp");
            sampleDist = serObj.FindProperty("sampleDist");
            edgeColor = serObj.FindProperty("edgeColor");
        ...
        public override void OnInspectorGUI () {
            ...
            GUILayout.Label("Detects spatial differences and converts into coloured outlines", EditorStyles.miniBoldLabel);
            ...
            EditorGUILayout.PropertyField(edgeColor, new GUIContent(" edgeColor"));
            ...
            EditorGUILayout.PropertyField(edgeDetectShader, new GUIContent(" Edge detect shader"));
