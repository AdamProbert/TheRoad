...
Shader "CrossSection/Standard (Specular setup)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERES
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERES // to get enumerated keywords as local.
	...
	SubShader
	{
		...
		Pass
		{
			...
			//#pragma multi_compile_local __ CLIP_PLANE // to get enumerated keywords as local.
			#include "CGIncludes/UnityStandardCoreForward_CS.cginc"
